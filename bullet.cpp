...
Bullet::Bullet(QPoint startPos, QPoint targetPoint, int damage, Enemyclass *target,
               Gamebase *game, const QPixmap &sprite/* = QPixmap(":/images/bullet.png")*/)
    : m_startPos(startPos)
...
void Bullet::hitTarget()
{
    ...
    // 后续炮弹再攻击到的敌人就是无效内存区域
    // 因此先判断下敌人是否还有效
    if (m_game->monsterlist().indexOf(m_target) != -1)
